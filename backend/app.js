...
//     await tempHolding.forEach(async(item)=>{
//         let newHolding = new HoldingsModel(item);
//         await newHolding.save();
//     });

//     await tempWatchList.forEach(async(item)=>{
//         let newWatchList = new WatchListModel(item);
//         await newWatchList.save();
//     });

//     await tempPositions.forEach(async(item)=>{
//         let newPositions = new PositionsModel(item);
